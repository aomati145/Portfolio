          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
            ...
            <div className="text-center md:text-left space-y-6 flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  href="#projects"
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-semibold transition-all hover:scale-105"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-full border-2 border-blue-600 hover:bg-blue-600/10 text-blue-400 hover:text-blue-300 font-semibold transition-all hover:scale-105"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
